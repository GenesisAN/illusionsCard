...
func (z *Attribute) DecodeMsg(dc *msgp.Reader) (err error) {
	...
	for zb0001 > 0 {
		...
		case "lonely":
			z.Lonely, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Lonely")
				return
			}
		case "love":
			z.Love, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Love")
				return
			}
		case "majime":
		...
		case "nakama":
			z.Nakama, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Nakama")
				return
			}
		case "nonbiri":
			z.Nonbiri, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Nonbiri")
				return
			}
		case "okute":
			z.Okute, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Okute")
				return
			}
		case "ongaku":
		...
		case "talk":
			z.Talk, err = dc.ReadBool()
			if err != nil {
				err = msgp.WrapError(err, "Talk")
				return
			}
		case "ukemi":
...
func (z *Attribute) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 24
	// write "active"
	err = en.Append(0xde, 0x0, 0x18, 0xa6, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65)
	if err != nil {
		return
	}
	...
	// write "hinnyo"
	err = en.Append(0xa6, 0x68, 0x69, 0x6e, 0x6e, 0x79, 0x6f)
	if err != nil {
		return
	}
	...
	// write "lonely"
	err = en.Append(0xa6, 0x6c, 0x6f, 0x6e, 0x65, 0x6c, 0x79)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Lonely)
	if err != nil {
		err = msgp.WrapError(err, "Lonely")
		return
	}
	// write "love"
	err = en.Append(0xa4, 0x6c, 0x6f, 0x76, 0x65)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Love)
	if err != nil {
		err = msgp.WrapError(err, "Love")
		return
	}
	...
	// write "nakama"
	err = en.Append(0xa6, 0x6e, 0x61, 0x6b, 0x61, 0x6d, 0x61)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Nakama)
	if err != nil {
		err = msgp.WrapError(err, "Nakama")
		return
	}
	// write "nonbiri"
	err = en.Append(0xa7, 0x6e, 0x6f, 0x6e, 0x62, 0x69, 0x72, 0x69)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Nonbiri)
	if err != nil {
		err = msgp.WrapError(err, "Nonbiri")
		return
	}
	// write "okute"
	err = en.Append(0xa5, 0x6f, 0x6b, 0x75, 0x74, 0x65)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Okute)
	if err != nil {
		err = msgp.WrapError(err, "Okute")
		return
	}
	...
	// write "talk"
	err = en.Append(0xa4, 0x74, 0x61, 0x6c, 0x6b)
	if err != nil {
		return
	}
	err = en.WriteBool(z.Talk)
	if err != nil {
		err = msgp.WrapError(err, "Talk")
		return
	}
...
func (z *Attribute) MarshalMsg(b []byte) (o []byte, err error) {
	...
	// map header, size 24
	// string "active"
	o = append(o, 0xde, 0x0, 0x18, 0xa6, 0x61, 0x63, 0x74, 0x69, 0x76, 0x65)
	...
	// string "hinnyo"
	o = append(o, 0xa6, 0x68, 0x69, 0x6e, 0x6e, 0x79, 0x6f)
	...
	// string "lonely"
	o = append(o, 0xa6, 0x6c, 0x6f, 0x6e, 0x65, 0x6c, 0x79)
	o = msgp.AppendBool(o, z.Lonely)
	// string "love"
	o = append(o, 0xa4, 0x6c, 0x6f, 0x76, 0x65)
	o = msgp.AppendBool(o, z.Love)
	// string "majime"
	...
	// string "nakama"
	o = append(o, 0xa6, 0x6e, 0x61, 0x6b, 0x61, 0x6d, 0x61)
	o = msgp.AppendBool(o, z.Nakama)
	// string "nonbiri"
	o = append(o, 0xa7, 0x6e, 0x6f, 0x6e, 0x62, 0x69, 0x72, 0x69)
	o = msgp.AppendBool(o, z.Nonbiri)
	// string "okute"
	o = append(o, 0xa5, 0x6f, 0x6b, 0x75, 0x74, 0x65)
	o = msgp.AppendBool(o, z.Okute)
	// string "ongaku"
	...
	// string "talk"
	o = append(o, 0xa4, 0x74, 0x61, 0x6c, 0x6b)
	o = msgp.AppendBool(o, z.Talk)
	// string "ukemi"
...
func (z *Attribute) UnmarshalMsg(bts []byte) (o []byte, err error) {
	...
	for zb0001 > 0 {
		...
		case "info":
			z.Info, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Info")
				return
			}
		...
		case "lonely":
			z.Lonely, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Lonely")
				return
			}
		case "love":
			z.Love, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Love")
				return
			}
		...
		case "nakama":
			z.Nakama, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Nakama")
				return
			}
		case "nonbiri":
			z.Nonbiri, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Nonbiri")
				return
			}
		case "okute":
			z.Okute, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Okute")
				return
			}
		...
		case "talk":
			z.Talk, bts, err = msgp.ReadBoolBytes(bts)
			if err != nil {
				err = msgp.WrapError(err, "Talk")
				return
			}
...
func (z *Attribute) Msgsize() (s int) {
	s = 3 + 7 + msgp.BoolSize + 6 + msgp.BoolSize + 7 + msgp.BoolSize + 8 + msgp.BoolSize + 9 + msgp.BoolSize + 9 + msgp.BoolSize + 7 + msgp.BoolSize + 7 + msgp.BoolSize + 5 + msgp.BoolSize + 10 + msgp.BoolSize + 10 + msgp.BoolSize + 7 + msgp.BoolSize + 5 + msgp.BoolSize + 7 + msgp.BoolSize + 8 + msgp.BoolSize + 7 + msgp.BoolSize + 8 + msgp.BoolSize + 6 + msgp.BoolSize + 7 + msgp.BoolSize + 9 + msgp.BoolSize + 5 + msgp.BoolSize + 6 + msgp.BoolSize + 5 + msgp.BoolSize + 17 + msgp.GuessSize(z.ExtendedSaveData)
	return
}
...
// DecodeMsg implements msgp.Decodable
func (z *KKSChaFileParameter) DecodeMsg(dc *msgp.Reader) (err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, err = dc.ReadMapHeader()
...
// EncodeMsg implements msgp.Encodable
func (z *KKSChaFileParameter) EncodeMsg(en *msgp.Writer) (err error) {
	// map header, size 21
	// write "version"
...
// MarshalMsg implements msgp.Marshaler
func (z *KKSChaFileParameter) MarshalMsg(b []byte) (o []byte, err error) {
	o = msgp.Require(b, z.Msgsize())
	// map header, size 21
	// string "version"
...
// UnmarshalMsg implements msgp.Unmarshaler
func (z *KKSChaFileParameter) UnmarshalMsg(bts []byte) (o []byte, err error) {
	var field []byte
	_ = field
	var zb0001 uint32
	zb0001, bts, err = msgp.ReadMapHeaderBytes(bts)
...
// Msgsize returns an upper bound estimate of the number of bytes occupied by the serialized message
func (z *KKSChaFileParameter) Msgsize() (s int) {
